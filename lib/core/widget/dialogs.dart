...
import 'package:imsmart_admin/core/widget/flutter_custom_dialog.dart';
...
class AppDialog {
  ...
  static YYDialog showAuthDialog(BuildContext context,
      {String title = "Two factor code", required Function onContinue}) {
          ...
          return Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                TextView(
                  text:
                      "Copy the code generated on your Authenticator app, note that the code changes within a few seconds.",
                  textStyle: GoogleFonts.roboto(
                      fontSize: setSp(18),
                      color: Pallet.black,
                      fontWeight: FontWeight.w500),
                ...
                TextView(
                  text:
                      "This serves as a second layer protection on your account to prevent unauthorized access.",
                  textStyle: GoogleFonts.roboto(
                      fontSize: setSp(14),
                      color: Pallet.black,
                      fontWeight: FontWeight.w400),
                    ...
                    CustomButtonWidget(
                        ...
                        onTap: () async {
                          var result = await context
                              .provideOnce<AuthProvider>()
                              .verifyTwoFa(
                                  context: context, token: _otpController.text);
